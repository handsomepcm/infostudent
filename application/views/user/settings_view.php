...
<div class="row">
  	<div class="col-md-6">
	  	<h3><?php echo ucfirst($privilege);?></h3>
	  	<div class="row">
		...
		<div class="row">
			<div class="col-md-4"></div>
		  	...
		  	<div class="col-md-4"><h5>************* [<a href="<?php echo base_url("users/change_password")?>">change</a>]</h5></div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4"><h4>Email Address</h4></div>
		 	<div class="col-md-4"><h5><?php echo $email_address;?> [<a href="<?php echo base_url("users/change_email_address")?>">change</a>]</h5></div>
		</div>
  	</div>
