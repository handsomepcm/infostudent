...
<div class="row">
  <div class="col-md-6">
    <form class="form-horizontal" role="form" id="add_csv" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?php echo base_url()?>registrar/csv_grades" >
      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
      <a href="<?php echo base_url()?>registrar/csv_grades_download" class="btn btn-info">Download CSV Format</a><br><br>
      <?php
        if (isset($ierror)) 
        {
